...
public class AppDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Course>().HasData(
            new Course { Id = 1, Code = "PRG-201", Name = "Lập Trình Hướng Đối Tượng C#", Instructor = "Cô Lê Thị Hoa", TuitionFee = 2500000, CurrentEnrollment = 28, MaxCapacity = 30, StartDate = new DateTime(2026, 9, 10), CourseCategoryId = 1 },
